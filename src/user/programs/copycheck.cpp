...
int main(void)
{
	...
	const long observe_ok = os1::user::observe(OS1_OBSERVE_SYSTEM, observe_buffer, sizeof(observe_buffer));
	...
	if(-1 != os1::user::observe(OS1_OBSERVE_SYSTEM, (void*)kReadOnlyObserveBuffer, sizeof(kReadOnlyObserveBuffer)))
	{
