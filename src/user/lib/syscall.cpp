...
{
    long result = 0;
    asm volatile("int $0x80" : "=a"(result) : "a"(number) : "memory", "cc");
    return result;
}
...
{
    long result = 0;
    asm volatile("int $0x80" : "=a"(result) : "a"(number), "D"(arg0) : "memory", "cc");
    return result;
}
...
{
    long result = 0;
    asm volatile("int $0x80" : "=a"(result) : "a"(number), "D"(arg0), "S"(arg1) : "memory", "cc");
    return result;
}
