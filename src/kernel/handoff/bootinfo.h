...
// native firmware/loader state into BootInfo before entering KernelMain.
#ifndef OS1_KERNEL_HANDOFF_BOOTINFO_H
#define OS1_KERNEL_HANDOFF_BOOTINFO_H
...
struct BootInfo
{
	// Magic/version pair lets KernelMain reject malformed handoffs early.
	uint64_t magic;
	uint32_t version;
	...
	// Boot-owned strings copied by OwnBootInfo before boot memory is reclaimed.
...
#endif // OS1_KERNEL_HANDOFF_BOOTINFO_H
